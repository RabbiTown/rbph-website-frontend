...
export default defineI18nLocale(() => ({
  ...
  activityLog: {
    ...
    access: {
      ...
      teamBetaEnabled: 'ベータテストチームに設定しました',
      teamBetaDisabled: 'ベータテストチーム設定を解除しました',
      teamStarted: 'チームを開始済みに設定しました',
      teamUnstarted: 'チームを未開始に設定しました',
      currencyInitialized: 'チーム通貨を初期化しました',
      currencyReset: 'チーム通貨をリセットしました',
      currencyRemoved: 'チーム通貨を削除しました',
  ...
  globalSync: {
    frontendTheme: {
      updated: '画面が更新されました',
      reloadDescription: 'ページを再読み込みすると最新の画面を利用できます。',
      reload: '再読み込み',
    },
    notification: {
      received: '新しい通知',
  ...
  ticket: {
    ...
    noUnlock: '無料',
    unlockRequirements: 'アンロック条件',
    addUnlockRequirement: '追加',
    cooldownRequirement: 'クールダウン',
    unlocksIn: '{time} 後にアンロック',
    unlockAt: 'アンロック日時：{time}',
    cooldownWithCost: '{time} 後に {cost} でアンロック可能',
    noBidWarningTitle: 'アンロック条件がありません',
    noBidWarningDescription: 'このヒント返信にはクールダウンも通貨オファーもありません。このまま送信しますか？',
    sendWithoutBid: 'そのまま送信',
    dontRemindForGame: 'このゲームでは今後表示しない',
    loadTeamCurrenciesFailed: 'チーム通貨の読み込みに失敗しました',
  ...
  hints: {
    ...
    unlock: 'アンロック',
    cooldownPending: 'クールダウン終了後に購入できます',
    notEnabled: '未有効',
    notEnabledDescription: '有効化条件を満たすと購入できます',
    needMore: 'あと{amount}必要です',
    insufficientBalance: '残高が不足しています。',
    unavailableOrPurchased: 'このヒントはまだ購入できないか、購入済みです。',
  ...
  pages: {
    ...
    profile: {
      ...
      passwordSaved: 'パスワードを変更しました',
      passwordSaveFailed: 'パスワードを変更できませんでした',
      invalidUserInfo: 'プロフィールが正しくありません。',
      ...
      teamBannedContact: 'チームは利用停止中です。スタッフにお問い合わせください。',
  ...
  admin: {
    frontend: {
      title: 'インターフェース',
      description: 'テーマパッケージ、ページレンダラー、共通の表示機能を管理します。',
      badges: {
        development: '開発中',
        online: '公開中',
      },
      common: {
        selectPageConfig: 'ページ設定を選択',
        applyToDraft: '下書きに反映',
        builtinPage: '標準ページ',
        ...
        round: 'ラウンド',
        roundPage: 'ラウンドページ',
        customThemePackage: 'テーマパッケージ',
        draftVersion: '下書き {version}',
        fullWidth: '全幅',
        inheritParent: '上位設定を継承',
        packagePendingDeletion: '削除予約済み',
        previewDraft: '下書きをプレビュー',
        renderer: 'レンダラー',
        saveToDraft: '下書きに保存',
        selectRenderer: 'レンダラーを選択',
        standard: '標準',
        fileDrop: 'クリックして選択、またはファイルをドロップ',
        pendingAutomaticDeletion: '削除予約',
        version: 'リビジョン {version}',
      },
      features: {
        locale: 'ローカライズ',
        localeDescription: 'テーマパッケージが提供するロケールファイルを適用します。',
        icons: 'アイコン',
        iconsDescription: 'テーマパッケージに同梱されたアイコンを読み込みます。',
        ui: 'UI変更',
        uiDescription: '標準のプレイヤー画面で使われる要素を変更します。',
      },
      notifications: {
        bindingSaved: 'ページ設定を下書きに保存しました',
        configApplied: '設定を下書きに反映しました',
        configLoaded: '設定を読み込みました',
        packageDeleted: 'テーマパッケージを削除しました',
        packagePendingDeletion: 'テーマパッケージの削除を予約しました',
        packageRestored: '削除予約を取り消しました',
        packageUploaded: 'テーマパッケージをアップロードしました',
        published: '下書きを公開しました',
      },
      packages: {
        title: 'テーマパッケージ',
        description: 'このゲームで利用できるテーマパッケージを管理します。',
        selectZip: 'ZIP ファイルを選択',
        cancelDeletion: '削除予約を取り消す',
        cancelDeletionDescription: 'このパッケージを下書きで再び利用できるようにします。',
        delete: 'パッケージを削除',
        deleteDescription: '公開中のパッケージは削除予約となり、下書きの公開時に処理されます。',
        confirmDelete: '削除する',
      },
      configFile: {
        title: 'インターフェース設定',
        description: '下書きの設定全体を確認・編集し、JSON ファイルとして読み込みまたは書き出しできます。',
        download: 'ダウンロード',
        downloadJson: 'JSON をダウンロード',
        upload: '読み込み',
        selectJson: 'JSON ファイルを選択',
        loadJson: '設定を読み込む',
        gameDefaults: 'ゲームのデフォルト',
        pageOverrides: 'ラウンド・問題ごとの設定',
        noPageOverrides: 'ラウンドや問題のページから専用のインターフェースを設定できます。',
        roundScope: 'ラウンド {id}',
        puzzleScope: '問題 {id}',
        roundDefaultPuzzlePage: 'ラウンドのデフォルト問題ページ',
        unsavedChanges: 'インターフェース設定の変更はまだ下書きに反映されていません。',
      },
      publish: {
        title: '公開',
        description: '現在の下書きをプレイヤー向けに公開します。',
        action: '下書きを公開',
        currentDraft: '現在の下書き',
        bindingCount: 'ページ設定 {count} 件',
        onlineDescription: '現在プレイヤーが使用している設定です。',
        notPublished: '未公開',
      },
      scope: {
        saved: 'ページ設定を保存しました',
      ...
      editors: {
        roundPage: 'ラウンドページ',
        puzzlePage: '問題ページ',
        roundPuzzleDefault: 'ラウンド内問題のデフォルト',
      },
      dev: {
        developmentPreview: '開発プレビュー',
        shortTitle: 'テーマ確認',
        selectedConfiguration: '選択中の設定',
        resetDescription: 'すべての変更を「{source}」に置き換えます。',
        gameDefaultModification: 'ゲームのデフォルト · {surface}',
        roundModification: 'ラウンド {id}',
        puzzleModification: '問題 {id}',
        bindingModification: 'ページ設定 {key}',
        baseFeaturesModification: 'ゲーム共通機能',
        packageFeaturesModification: '{package} · 機能',
        disableAllFeatures: 'すべて無効',
        inheritGameDefault: 'ゲームのデフォルトを継承',
        onlineThemePackage: '公開中のテーマパッケージ',
        applied: '変更を下書きに反映しました',
        resetComplete: '変更をリセットしました',
        title: 'テーマ開発',
        pagePackageContext: '{surface}・{scope} {id}・{package}',
        gamePackageContext: 'ゲーム設定・{package}',
        previewSource: 'プレビュー元',
        currentPage: '現在のページ',
        gameDefaults: 'ゲームのデフォルト',
        gameDefaultsDescription: '個別の変更がないページで使用する表示方法を設定します。',
        packageFeatures: 'パッケージ機能',
        packageFeaturesDescription: '開発中のパッケージから有効にする共通機能を選択します。',
        adminUnavailable: '開発設定の編集と反映には管理者でのログインが必要です。',
        modificationCount: '変更 {count} 件',
        reset: 'リセット',
        modifications: '変更内容',
        removeModification: '変更を削除',
        openPage: 'ページを開く',
        noModifications: '変更はありません',
        resetTitle: '開発設定をリセット',
        confirmReset: 'リセットする',
        resetTarget: '戻し先',
        manifestFetchFailed: '開発テーマのマニフェストを取得できませんでした（HTTP {status}）。',
        manifestInvalid: '開発テーマのマニフェストが無効です。',
        missingScopeId: '現在のページに{scope} ID がありません。',
      },
      errorTitles: {
        loadSettings: 'インターフェース設定の読み込みに失敗しました',
        saveFeature: 'テーマ機能設定の保存に失敗しました',
        uploadPackage: 'テーマパッケージのアップロードに失敗しました',
        deletePackage: 'テーマパッケージの削除に失敗しました',
        restorePackage: '削除予約の取り消しに失敗しました',
        downloadConfig: 'インターフェース設定のダウンロードに失敗しました',
        uploadConfig: 'インターフェース設定を処理できませんでした',
        saveBinding: 'ページ設定の保存に失敗しました',
        publish: 'インターフェース設定の公開に失敗しました',
        applyDevelopmentConfig: '変更を下書きに適用できません',
      },
      errors: {
        common: {
          invalidPackageManifest: 'テーマパッケージのマニフェストデータが無効です。',
          rendererRequired: 'テーマパッケージのレンダラーを選択してください。',
          rendererUnavailable: '選択したレンダラーは存在しないか、このページをサポートしていません。',
          packageNotFound: 'テーマパッケージは存在しないか、削除されています。',
          packagePendingDeletion: 'このテーマパッケージは削除予約済みです。',
          invalidRevision: '下書きのリビジョンが変更されました。再読み込みしてからもう一度お試しください。',
        },
        config: {
          invalidFormat: 'この設定ファイルのバージョンはサポートされていません。',
          missingPackage: '設定が未アップロードまたは削除予約済みのテーマパッケージを参照しています。',
          missingPackagesTitle: 'テーマパッケージが不足しています',
          missingPackagesDescription: '設定が未アップロードのテーマパッケージを参照しています。下書きは変更されていません。',
          close: '閉じる',
          missingNamedPackage: 'テーマパッケージ「{name}」は未アップロードまたは削除予約済みです。下書きに適用する前に管理画面からアップロードしてください。',
          invalidBinding: '設定に無効または重複したページ設定が含まれています。',
          invalidFeature: '設定に重複した機能、またはテーマパッケージがサポートしない機能が含まれています。',
          invalidFile: '選択したファイルは有効なインターフェース設定ではありません。',
          draftUnavailable: 'インターフェース下書き管理 API を利用できません。',
        },
        package: {
          gameNotFound: 'ゲームが存在しません。',
          archiveTooLarge: 'テーマパッケージが 64 MiB の上限を超えています。',
          ...
          newerPackageExists: '先に新しくアップロードした同名パッケージを削除してください。',
          notPendingDeletion: 'このテーマパッケージは削除予約されていません。',
        },
        binding: {
          invalidSurface: 'ページ種別と設定範囲が一致しません。',
          invalidScope: '設定されたゲーム、ラウンド、または問題が存在しません。',
          unexpectedRenderer: '標準ページにテーマレンダラーは指定できません。',
        },
        feature: {
          unsupportedFeature: 'このテーマパッケージは選択した機能をサポートしていません。',
        },
        publish: {
          revisionNotFound: '公開対象の下書きが存在しないか、すでに変更されています。',
        },
      },
    },
    common: {
    ...
    pages: {
      ...
      game: {
        ...
        settings: {
          ...
          allowDuplicateTeamNames: '同名チームを許可',
          ...
          staffNicknameInvalid: 'スタッフの表示名が無効です',
          staffNicknameLengthHint: '60文字以内で入力してください。共通表示しない場合は空欄にします。',
          staffAvatar: 'スタッフのアバター',
          staffAvatarDescription: 'アバターの提供元を選択します。',
          staffAvatarEmail: 'スタッフのアバター用メールアドレス',
          staffAvatarEmailDescription: 'アバター生成にのみ使用し、プレイヤーには表示しません。',
          staffAvatarEmailPlaceholder: '共通アバターを設定しない',
          staffAvatarEmailInvalid: 'スタッフのアバター用メールアドレスが無効です',
          staffAvatarEmailLengthHint: '255文字以内で入力してください。設定しない場合は空欄にします。',
      ...
      puzzle: {
        ...
        hints: {
          ...
          invalidHintDescription: 'タイトル、待ち時間、表示条件、通貨コスト、バックエンド関数名を確認してください。',
          ...
          defaultEnableCondition: '問題の解放',
          defaultDisplayCondition: '問題の解放',
          defaultTitleDisplayCondition: 'クールダウン終了',
          unlockCost: '解放コスト',
          ...
          fromHintDisplayed: 'ヒントの表示',
          fromHintTitleDisplayed: 'タイトルの表示',
          unlockFunction: '関数',
          ...
          triggerDescription: 'ヒントの解放時に記録するフィールド',
          hintContent: 'ヒントの内容',
      ...
      team: {
        ...
        accessChange: {
          ...
          start: '開始済みに設定',
          unstart: '未開始に設定',
          enableBeta: 'ベータテストチームに設定',
          disableBeta: 'ベータテストチーム設定を解除',
        },
        featureAction: {
          enable: '{feature}を有効化',
        ...
        beta: 'ベータテストチーム',
        betaDescription: {
          enabled: 'メンバーはゲームの開放前でもゲームに入れます。',
          disabled: 'メンバーはゲームの開放後に入れます。',
        },
        createdAt: '{time}に作成',
        info: '基本情報',
        featureAccess: '機能アクセス',
        competitionState: 'ゲーム進行状況',
        started: '開始済み',
        notStarted: '未開始',
        competitionStateDescription: {
          started: 'このチームはゲームを開始しています。',
          notStarted: 'このチームはまだゲームを開始していません。',
        },
        startCompetitionTitle: 'チームを開始済みに設定しますか？',
        startCompetitionDescription: '開始時刻は保存時に記録されます。',
        unstartCompetitionTitle: 'チームを未開始に戻しますか？',
        unstartCompetitionDescription: 'このチームは開始済みと見なされなくなります。既存の問題進行状況は保持されます。',
        startInitializeCurrency: 'このチームの通貨を初期化',
        unstartRemoveCurrency: 'このチームの通貨を削除',
      ...
      settings: {
        ...
        leaderboardRefreshInterval: 'ランキング更新間隔',
        leaderboardRefreshIntervalDescription: '提出やチーム情報の変更後に、ランキングのスナップショットをまとめて更新する頻度。',
        footer: 'フッター',
  ...
  components: {
    ...
    teamPuzzleStatus: {
      menu: '問題の状態',
      title: 'チーム「{team}」・「{puzzle}」',
      description: 'この問題の解放、回答送信、ヒントの状態を確認します。',
      locked: '未解放',
      unlocked: '解放済み',
      solved: 'クリア済み',
      teamBanned: 'チームは利用停止中です',
      puzzleLocked: '問題は未解放です',
      submissionDisabled: '回答送信が設定されていません',
      requirementsNotMet: '回答送信条件を満たしていません',
      coolingDown: '回答送信のクールダウン：{time}',
      submissionsExhausted: '回答送信回数を使い切りました',
      canSubmit: '現在回答を送信できます',
      unlockTime: '解放日時',
      solveTime: 'クリア日時',
      notSolved: '未クリア',
      incorrectSubmissions: '不正解の送信回数',
      remainingSubmissions: '残り送信回数',
      unlimited: '無制限',
      cooldownUntil: 'クールダウン終了',
      hints: 'ヒント購入状況',
      noHints: 'この問題にはプリセットヒントがありません',
      free: '無料',
      hintNotPurchased: '未購入',
      hintNotEnabled: '未有効',
      hintPurchased: '購入済み',
      hintUnlocked: '解放済み',
      hintState: 'ヒントの状態',
      hintPrice: '解放価格',
      hintCooldownUntil: 'クールダウン終了日時',
      hintUnlockedAt: '解放日時',
      notUnlocked: '未購入・未解放',
      availableIn: '{time}後に利用可能',
      submissions: '回答送信履歴',
      onlySuccessfulSubmissions: '正解のみ',
      ignored: '無視',
      realAnswer: '正解：{answer}',
      openPuzzle: '問題を表示',
      loadFailed: '問題の状態を取得できませんでした',
      submissionsLoadFailed: '回答送信履歴を取得できませんでした',
      hintLoadFailed: 'ヒント内容を取得できませんでした',
      retry: '再試行',
      refresh: '更新',
    },
    ...
    rbphUnlockGateBlock: {
      gateType: {
        ...
        false: '常に不成立',
        gameStarted: 'ゲーム開始',
        hintEnabled: 'ヒント有効化済み',
        hintCooledDown: 'ヒントのクールダウン完了',
        puzzleSolved: '問題クリア',
        allSolved: 'すべてクリア',
        anySolved: 'いずれかクリア',
        compare: '比較',
