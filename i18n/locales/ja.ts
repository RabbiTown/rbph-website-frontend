    ...
    pages: {
      ...
      puzzle: {
        ...
        hints: {
          ...
          titleDisplayConditionDescription: '購入前に実際のタイトルを表示するタイミングを制御します。ヒント自体が非表示の間はタイトルも表示されません。',
          displayCondition: 'ヒント表示条件',
          displayConditionDescription: '購入前にヒントカードを表示するタイミングを制御します。購入後は常に表示されます。',
          displayConditions: {
            always: '常に',
            enabled: '有効化後',
            cooldown: 'クールダウン後',
          ...
          enableConditionDescription: 'チームが初めて条件を満たすと、ヒントは有効なままになります。空欄の場合は最初から有効です。',
