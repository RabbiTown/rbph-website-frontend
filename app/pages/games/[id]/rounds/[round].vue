...
let fetchToken = 0;
async function updateData(id: string | undefined = undefined, ref: string | undefined = undefined, clearExisting = true) {
...
const rendererActions = {
  ...
  listSubmissions,
  refresh: async () => updateData(undefined, undefined, false),
